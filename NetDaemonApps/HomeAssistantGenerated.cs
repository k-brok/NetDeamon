...
//   At: 2025-12-23T14:50:50.0851850+01:00
//
...
public static class GeneratedExtensions
{
    ...
    public static IServiceCollection AddHomeAssistantGenerated(this IServiceCollection serviceCollection)
    {
        ...
        serviceCollection.AddTransient<GrocyServices>();
...
public partial class LightEntities
{
    ...
    ///<summary>Lamp kast</summary>
    public LightEntity Ac27bc0cfe0 => new(_haContext, "light.ac_27bc0cfe_0");
    ///<summary>AC Pro - Garage LED</summary>
    public LightEntity AcProGarageLed => new(_haContext, "light.ac_pro_garage_led");
    ///<summary>AC Pro - Woonkamer LED</summary>
    public LightEntity AcProWoonkamerLed => new(_haContext, "light.ac_pro_woonkamer_led");
    ///<summary>AP-zolder LED</summary>
    public LightEntity ApZolderLed => new(_haContext, "light.ap_zolder_led");
    ///<summary>Kerstboom</summary>
    public LightEntity Kerstboom => new(_haContext, "light.kerstboom");
    ...
    ///<summary>Shelly_Voortuin_Lamp</summary>
    public LightEntity ShellyVoortuinLamp => new(_haContext, "light.shelly_voortuin_lamp");
...
public partial class BinarySensorEntities
{
    ...
    ///<summary>Shelly_Voortuin_Lamp Input 0</summary>
    public BinarySensorEntity ShellyVoortuinLampInput0 => new(_haContext, "binary_sensor.shelly_voortuin_lamp_input_0");
    ///<summary>Shelly_Voortuin_Stopcontact Input 0</summary>
    public BinarySensorEntity ShellyVoortuinStopcontactInput0 => new(_haContext, "binary_sensor.shelly_voortuin_stopcontact_input_0");
    ...
    ///<summary>Shelly_Woonkamer_Schaklaars_Bar Input</summary>
    ...
    ///<summary>Shelly_Woonkamer_Serre_Lamp Input</summary>
    ...
    ///<summary>Voortuin All occupancy</summary>
    public BinarySensorEntity VoortuinAllOccupancy => new(_haContext, "binary_sensor.voortuin_all_occupancy");
    ///<summary>Voortuin Person occupancy</summary>
    public BinarySensorEntity VoortuinPersonOccupancy => new(_haContext, "binary_sensor.voortuin_person_occupancy");
...
public partial class ButtonEntities
{
    ...
    ///<summary>Energie meter Herstarten</summary>
...
public partial class DeviceTrackerEntities
{
    ...
    ///<summary>DESKTOP-I0J7T8D</summary>
    public DeviceTrackerEntity DesktopI0j7t8d => new(_haContext, "device_tracker.desktop_i0j7t8d");
    ///<summary>envoy</summary>
    public DeviceTrackerEntity Envoy => new(_haContext, "device_tracker.envoy");
    ///<summary>FamBrok</summary>
    public DeviceTrackerEntity Fambrok => new(_haContext, "device_tracker.fambrok");
    ///<summary>frigate</summary>
    public DeviceTrackerEntity Frigate => new(_haContext, "device_tracker.frigate");
    ...
    ///<summary>kc-01</summary>
    public DeviceTrackerEntity Kc01 => new(_haContext, "device_tracker.kc_01");
    ///<summary>kd-01</summary>
    public DeviceTrackerEntity Kd01 => new(_haContext, "device_tracker.kd_01");
    ///<summary>kw-01</summary>
    public DeviceTrackerEntity Kw01 => new(_haContext, "device_tracker.kw_01");
    ///<summary>kw-02</summary>
    public DeviceTrackerEntity Kw02 => new(_haContext, "device_tracker.kw_02");
    ///<summary>LocalHost</summary>
    public DeviceTrackerEntity Localhost => new(_haContext, "device_tracker.localhost");
    ///<summary>shelly1mini-543204bae5ec</summary>
    ...
    ///<summary>shelly1mini-543204baa850</summary>
    ...
    ///<summary>shelly1mini-543204b9eba0</summary>
    ...
    ///<summary>shelly1mini-543204b8dce4</summary>
    ...
    ///<summary>shelly1mini-543204b8f67c</summary>
    ...
    ///<summary>shellyswitch25-40F52027AE4D</summary>
    ...
    ///<summary>shelly1mini-543204ba9294</summary>
    ...
    ///<summary>shelly1-34945470BD7D</summary>
    ...
    ///<summary>shelly1mini-543204b8f7a8</summary>
    ...
    ///<summary>shelly1mini-543204b9d78c</summary>
    ...
    ///<summary>shelly1mini-543204b96788</summary>
    ...
    ///<summary>shelly1mini-543204baae20</summary>
    ...
    ///<summary>shelly1mini-543204ba9ca0</summary>
    ...
    public DeviceTrackerEntity ShellyVoortuinLampShelly1mini543204b9b26c => new(_haContext, "device_tracker.shelly_voortuin_lamp_shelly1mini_543204b9b26c");
    ///<summary>Shelly_Voortuin_Stopcontact shelly1mini-543204b8f5ec</summary>
    public DeviceTrackerEntity ShellyVoortuinStopcontactShelly1mini543204b8f5ec => new(_haContext, "device_tracker.shelly_voortuin_stopcontact_shelly1mini_543204b8f5ec");
    ///<summary>shelly1mini-543204bb90dc</summary>
    ...
    ///<summary>shellyix3-8CAAB5436FF2</summary>
    ...
    ///<summary>shellydimmer2-C8C9A325AA51</summary>
    ...
    public DeviceTrackerEntity UnifiDefault50B03b0cE3E6 => new(_haContext, "device_tracker.unifi_default_50_b0_3b_0c_e3_e6");
    public DeviceTrackerEntity UnifiDefaultA0Bd1d16Ab9d => new(_haContext, "device_tracker.unifi_default_a0_bd_1d_16_ab_9d");
    public DeviceTrackerEntity UnifiDefaultA0Bd1d16Ad8d => new(_haContext, "device_tracker.unifi_default_a0_bd_1d_16_ad_8d");
    public DeviceTrackerEntity UnifiDefaultDa9679E4C8E0 => new(_haContext, "device_tracker.unifi_default_da_96_79_e4_c8_e0");
...
public partial class EventEntities
{
    ...
    ///<summary>Shelly_Garage_Lamp Ingang </summary>
...
public partial class InputBooleanEntities
{
    ...
    public InputBooleanEntity Kerstverlichting => new(_haContext, "input_boolean.kerstverlichting");
    ///<summary>netdaemon_kasper_deurbel_notification</summary>
    public InputBooleanEntity NetdaemonKasperDeurbelNotification => new(_haContext, "input_boolean.netdaemon_kasper_deurbel_notification");
    ///<summary>netdaemon_motion_notification</summary>
    public InputBooleanEntity NetdaemonMotionNotification => new(_haContext, "input_boolean.netdaemon_motion_notification");
    ///<summary>netdaemon_switch_overloop</summary>
    public InputBooleanEntity NetdaemonSwitchOverloop => new(_haContext, "input_boolean.netdaemon_switch_overloop");
    ///<summary>netdaemon_switch_serre</summary>
    public InputBooleanEntity NetdaemonSwitchSerre => new(_haContext, "input_boolean.netdaemon_switch_serre");
    ///<summary>netdaemon_toilet10min</summary>
    public InputBooleanEntity NetdaemonToilet10min => new(_haContext, "input_boolean.netdaemon_toilet10min");
    ///<summary>netdaemon_trapkast2min</summary>
    public InputBooleanEntity NetdaemonTrapkast2min => new(_haContext, "input_boolean.netdaemon_trapkast2min");
}
...
public partial class SensorEntities
{
    ...
    ///<summary>Drogtrommel Vermogensfactor</summary>
    ...
    ///<summary>Vaatwasser Vermogensfactor</summary>
    ...
    ///<summary>Voordeur Review Status</summary>
    public SensorEntity VoordeurReviewStatus => new(_haContext, "sensor.voordeur_review_status");
    ...
    ///<summary>Wasmachine Vermogensfactor</summary>
    public SensorEntity WasmachinePowerFactor => new(_haContext, "sensor.wasmachine_power_factor");
    ///<summary>Woonkamer Review Status</summary>
    public SensorEntity WoonkamerReviewStatus => new(_haContext, "sensor.woonkamer_review_status");
    ...
    ///<summary>AC Pro - Garage CPU utilization</summary>
    public NumericSensorEntity AcProGarageCpuUtilization => new(_haContext, "sensor.ac_pro_garage_cpu_utilization");
    ///<summary>AC Pro - Garage Memory utilization</summary>
    public NumericSensorEntity AcProGarageMemoryUtilization => new(_haContext, "sensor.ac_pro_garage_memory_utilization");
    ...
    ///<summary>Grocy meal plan</summary>
    public NumericSensorEntity GrocyMealPlan => new(_haContext, "sensor.grocy_meal_plan");
    ...
    ///<summary>Drogtrommel Energie</summary>
    ...
    ///<summary>Voortuin All Active Count</summary>
    public NumericSensorEntity VoortuinAllActiveCount => new(_haContext, "sensor.voortuin_all_active_count");
    ///<summary>Voortuin All count</summary>
    public NumericSensorEntity VoortuinAllCount => new(_haContext, "sensor.voortuin_all_count");
    ///<summary>Voortuin Person Active Count</summary>
    public NumericSensorEntity VoortuinPersonActiveCount => new(_haContext, "sensor.voortuin_person_active_count");
    ///<summary>Voortuin Person count</summary>
    public NumericSensorEntity VoortuinPersonCount => new(_haContext, "sensor.voortuin_person_count");
...
public partial class SwitchEntities
{
    ...
    ///<summary>Shelly_Voortuin_Lamp</summary>
    public SwitchEntity ShellyVoortuinLamp => new(_haContext, "switch.shelly_voortuin_lamp");
    ///<summary>Shelly_Voortuin_Stopcontact</summary>
    public SwitchEntity ShellyVoortuinStopcontact => new(_haContext, "switch.shelly_voortuin_stopcontact");
    ///<summary>Shelly_Woonkamer_Lamp</summary>
    ...
    ///<summary>Voordeur Review Alerts</summary>
    public SwitchEntity VoordeurReviewAlerts => new(_haContext, "switch.voordeur_review_alerts");
    ///<summary>Voordeur Review Detections</summary>
    public SwitchEntity VoordeurReviewDetections => new(_haContext, "switch.voordeur_review_detections");
    ...
    ///<summary>Woonkamer Review Alerts</summary>
    public SwitchEntity WoonkamerReviewAlerts => new(_haContext, "switch.woonkamer_review_alerts");
    ///<summary>Woonkamer Review Detections</summary>
    public SwitchEntity WoonkamerReviewDetections => new(_haContext, "switch.woonkamer_review_detections");
...
public partial class TodoEntities
{
    ...
    ///<summary>Grocy meal plan</summary>
    public TodoEntity GrocyMealPlan => new(_haContext, "todo.grocy_meal_plan");
...
public partial class UpdateEntities
{
    ...
    ///<summary>Grocy custom component update</summary>
    public UpdateEntity GrocyCustomComponentUpdate => new(_haContext, "update.grocy_custom_component_update");
    ...
    ///<summary>Shelly_Voortuin_Lamp Firmware</summary>
    public UpdateEntity ShellyVoortuinLampFirmware => new(_haContext, "update.shelly_voortuin_lamp_firmware");
    ///<summary>Shelly_Voortuin_Stopcontact Firmware</summary>
    public UpdateEntity ShellyVoortuinStopcontactFirmware => new(_haContext, "update.shelly_voortuin_stopcontact_firmware");
...
public partial class CalendarEntities
{
    ...
    ///<summary>Omroep kalender</summary>
    public CalendarEntity OmroepKalender => new(_haContext, "calendar.omroep_kalender");
}
...
public partial class Services : IServices
{
    ...
    public GrocyServices Grocy => new(_haContext);
...
public partial class FrigateServices
{
    ...
    ///<param name="name">Optional name for the exported recording. If not provided, the API will generate one. </param>
    public void ExportRecording(ServiceTarget target, object playbackFactor, DateTime startTime, DateTime endTime, string? name = null)
    {
        _haContext.CallService("frigate", "export_recording", target, new FrigateExportRecordingParameters { PlaybackFactor = playbackFactor, StartTime = startTime, EndTime = endTime, Name = name });
    }
...
public partial record FrigateExportRecordingParameters
{
    ...
    ///<summary>Optional name for the exported recording. If not provided, the API will generate one. </summary>
    [JsonPropertyName("name")]
    public string? Name { get; init; }
}
...
public partial class GoogleAssistantSdkServices
{
    ...
    ///<param name="command"> eg: turn off kitchen TV</param>
    ///<param name="mediaPlayer"> eg: media_player.living_room_speaker</param>
...
{
    ///<summary> eg: turn off kitchen TV</summary>
    [JsonPropertyName("command")]
    public string? Command { get; init; }

    ///<summary> eg: media_player.living_room_speaker</summary>
    [JsonPropertyName("media_player")]
    public string? MediaPlayer { get; init; }
}

public partial class GrocyServices
{
    private readonly IHaContext _haContext;
    public GrocyServices(IHaContext haContext)
    {
        _haContext = haContext;
    }

    ///<summary>Adds a single object of the given entity type</summary>
    public void AddGeneric(GrocyAddGenericParameters data)
    {
        _haContext.CallService("grocy", "add_generic", null, data);
    }

    ///<summary>Adds a single object of the given entity type</summary>
    ///<param name="entityType">The type of entity you like to add. eg: tasks</param>
    ///<param name="data">JSON object with what data you want to add (yaml format also works). See Grocy api documentation on Generic entity interactions: https://demo.grocy.info/api</param>
    public void AddGeneric(object entityType, object data)
    {
        _haContext.CallService("grocy", "add_generic", null, new GrocyAddGenericParameters { EntityType = entityType, Data = data });
    }

    ///<summary>Adds currently missing products to the given shopping list.</summary>
    public void AddMissingProductsToShoppingList(GrocyAddMissingProductsToShoppingListParameters data)
    {
        _haContext.CallService("grocy", "add_missing_products_to_shopping_list", null, data);
    }

    ///<summary>Adds currently missing products to the given shopping list.</summary>
    ///<param name="listId">The id of the shopping list to be added to. eg: 1</param>
    public void AddMissingProductsToShoppingList(string? listId = null)
    {
        _haContext.CallService("grocy", "add_missing_products_to_shopping_list", null, new GrocyAddMissingProductsToShoppingListParameters { ListId = listId });
    }

    ///<summary>Adds a given amount of a product to the stock</summary>
    public void AddProductToStock(GrocyAddProductToStockParameters data)
    {
        _haContext.CallService("grocy", "add_product_to_stock", null, data);
    }

    ///<summary>Adds a given amount of a product to the stock</summary>
    ///<param name="productId">The id of the product to add to stock eg: 3</param>
    ///<param name="amount">The amount to add to stock eg: 3</param>
    ///<param name="price">The purchase price per purchase quantity unit of the added product eg: 1.99</param>
    public void AddProductToStock(string productId, long amount, string? price = null)
    {
        _haContext.CallService("grocy", "add_product_to_stock", null, new GrocyAddProductToStockParameters { ProductId = productId, Amount = amount, Price = price });
    }

    ///<summary>Completes the given task</summary>
    public void CompleteTask(GrocyCompleteTaskParameters data)
    {
        _haContext.CallService("grocy", "complete_task", null, data);
    }

    ///<summary>Completes the given task</summary>
    ///<param name="taskId">The id of the task to complete eg: 3</param>
    public void CompleteTask(string taskId)
    {
        _haContext.CallService("grocy", "complete_task", null, new GrocyCompleteTaskParameters { TaskId = taskId });
    }

    ///<summary>Consumes a given amount of a product to the stock</summary>
    public void ConsumeProductFromStock(GrocyConsumeProductFromStockParameters data)
    {
        _haContext.CallService("grocy", "consume_product_from_stock", null, data);
    }

    ///<summary>Consumes a given amount of a product to the stock</summary>
    ///<param name="productId">The id of the product to consume eg: 3</param>
    ///<param name="amount">The amount to consume eg: 3</param>
    ///<param name="spoiled">If the product was removed because of spoilage eg: False</param>
    ///<param name="allowSubproductSubstitution">If subproduct substitution is allowed eg: False</param>
    ///<param name="transactionType">The type of the transaction. eg: CONSUME</param>
    public void ConsumeProductFromStock(string productId, long amount, object transactionType, bool? spoiled = null, bool? allowSubproductSubstitution = null)
    {
        _haContext.CallService("grocy", "consume_product_from_stock", null, new GrocyConsumeProductFromStockParameters { ProductId = productId, Amount = amount, Spoiled = spoiled, AllowSubproductSubstitution = allowSubproductSubstitution, TransactionType = transactionType });
    }

    ///<summary>Consumes the given recipe</summary>
    public void ConsumeRecipe(GrocyConsumeRecipeParameters data)
    {
        _haContext.CallService("grocy", "consume_recipe", null, data);
    }

    ///<summary>Consumes the given recipe</summary>
    ///<param name="recipeId">The id of the recipe to consume eg: 3</param>
    public void ConsumeRecipe(string recipeId)
    {
        _haContext.CallService("grocy", "consume_recipe", null, new GrocyConsumeRecipeParameters { RecipeId = recipeId });
    }

    ///<summary>Deletes a single object of the given entity type</summary>
    public void DeleteGeneric(GrocyDeleteGenericParameters data)
    {
        _haContext.CallService("grocy", "delete_generic", null, data);
    }

    ///<summary>Deletes a single object of the given entity type</summary>
    ///<param name="entityType">The type of entity to be deleted. eg: tasks</param>
    ///<param name="objectId">The ID of the entity to delete. eg: 1</param>
    public void DeleteGeneric(object entityType, string objectId)
    {
        _haContext.CallService("grocy", "delete_generic", null, new GrocyDeleteGenericParameters { EntityType = entityType, ObjectId = objectId });
    }

    ///<summary>Executes the given chore with an optional timestamp and executor</summary>
    public void ExecuteChore(GrocyExecuteChoreParameters data)
    {
        _haContext.CallService("grocy", "execute_chore", null, data);
    }

    ///<summary>Executes the given chore with an optional timestamp and executor</summary>
    ///<param name="choreId">The id of the chore to execute eg: 3</param>
    ///<param name="doneBy">The id of the user who executed the chore eg: 0</param>
    ///<param name="trackExecutionNow">If the chore execution should be tracked with the time now eg: False</param>
    ///<param name="skipped">Skip next chore schedule eg: False</param>
    public void ExecuteChore(string choreId, string doneBy, bool? trackExecutionNow = null, bool? skipped = null)
    {
        _haContext.CallService("grocy", "execute_chore", null, new GrocyExecuteChoreParameters { ChoreId = choreId, DoneBy = doneBy, TrackExecutionNow = trackExecutionNow, Skipped = skipped });
    }

    ///<summary>Opens a given amount of a product in stock</summary>
    public void OpenProduct(GrocyOpenProductParameters data)
    {
        _haContext.CallService("grocy", "open_product", null, data);
    }

    ///<summary>Opens a given amount of a product in stock</summary>
    ///<param name="productId">The id of the product to open eg: 3</param>
    ///<param name="amount">The amount to open eg: 1</param>
    ///<param name="allowSubproductSubstitution">If subproduct substitution is allowed eg: False</param>
    public void OpenProduct(string productId, long amount, bool? allowSubproductSubstitution = null)
    {
        _haContext.CallService("grocy", "open_product", null, new GrocyOpenProductParameters { ProductId = productId, Amount = amount, AllowSubproductSubstitution = allowSubproductSubstitution });
    }

    ///<summary>Removes a product in the given shopping list.</summary>
    public void RemoveProductInShoppingList(GrocyRemoveProductInShoppingListParameters data)
    {
        _haContext.CallService("grocy", "remove_product_in_shopping_list", null, data);
    }

    ///<summary>Removes a product in the given shopping list.</summary>
    ///<param name="listId">The id of the shopping list to be added to. eg: 1</param>
    ///<param name="productId">The id of the product to remove eg: 3</param>
    ///<param name="amount">The amount to remove eg: 3</param>
    public void RemoveProductInShoppingList(string productId, long amount, string? listId = null)
    {
        _haContext.CallService("grocy", "remove_product_in_shopping_list", null, new GrocyRemoveProductInShoppingListParameters { ListId = listId, ProductId = productId, Amount = amount });
    }

    ///<summary>Tracks the given battery</summary>
    public void TrackBattery(GrocyTrackBatteryParameters data)
    {
        _haContext.CallService("grocy", "track_battery", null, data);
    }

    ///<summary>Tracks the given battery</summary>
    ///<param name="batteryId">The id of the battery eg: 1</param>
    public void TrackBattery(string batteryId)
    {
        _haContext.CallService("grocy", "track_battery", null, new GrocyTrackBatteryParameters { BatteryId = batteryId });
    }

    ///<summary>Edits a single object of the given entity type</summary>
    public void UpdateGeneric(GrocyUpdateGenericParameters data)
    {
        _haContext.CallService("grocy", "update_generic", null, data);
    }

    ///<summary>Edits a single object of the given entity type</summary>
    ///<param name="entityType">The type of entity you like to update. eg: tasks</param>
    ///<param name="objectId">The ID of the entity to update. eg: 1</param>
    ///<param name="data">JSON object with what data you want to update (yaml format also works). See Grocy api documentation on Generic entity interactions: https://demo.grocy.info/api</param>
    public void UpdateGeneric(object entityType, string objectId, object data)
    {
        _haContext.CallService("grocy", "update_generic", null, new GrocyUpdateGenericParameters { EntityType = entityType, ObjectId = objectId, Data = data });
    }
}

public partial record GrocyAddGenericParameters
{
    ///<summary>The type of entity you like to add. eg: tasks</summary>
    [JsonPropertyName("entity_type")]
    public object? EntityType { get; init; }

    ///<summary>JSON object with what data you want to add (yaml format also works). See Grocy api documentation on Generic entity interactions: https://demo.grocy.info/api</summary>
    [JsonPropertyName("data")]
    public object? Data { get; init; }
}

public partial record GrocyAddMissingProductsToShoppingListParameters
{
    ///<summary>The id of the shopping list to be added to. eg: 1</summary>
    [JsonPropertyName("list_id")]
    public string? ListId { get; init; }
}

public partial record GrocyAddProductToStockParameters
{
    ///<summary>The id of the product to add to stock eg: 3</summary>
    [JsonPropertyName("product_id")]
    public string? ProductId { get; init; }

    ///<summary>The amount to add to stock eg: 3</summary>
    [JsonPropertyName("amount")]
    public long? Amount { get; init; }

    ///<summary>The purchase price per purchase quantity unit of the added product eg: 1.99</summary>
    [JsonPropertyName("price")]
    public string? Price { get; init; }
}

public partial record GrocyCompleteTaskParameters
{
    ///<summary>The id of the task to complete eg: 3</summary>
    [JsonPropertyName("task_id")]
    public string? TaskId { get; init; }
}

public partial record GrocyConsumeProductFromStockParameters
{
    ///<summary>The id of the product to consume eg: 3</summary>
    [JsonPropertyName("product_id")]
    public string? ProductId { get; init; }

    ///<summary>The amount to consume eg: 3</summary>
    [JsonPropertyName("amount")]
    public long? Amount { get; init; }

    ///<summary>If the product was removed because of spoilage eg: False</summary>
    [JsonPropertyName("spoiled")]
    public bool? Spoiled { get; init; }

    ///<summary>If subproduct substitution is allowed eg: False</summary>
    [JsonPropertyName("allow_subproduct_substitution")]
    public bool? AllowSubproductSubstitution { get; init; }

    ///<summary>The type of the transaction. eg: CONSUME</summary>
    [JsonPropertyName("transaction_type")]
    public object? TransactionType { get; init; }
}

public partial record GrocyConsumeRecipeParameters
{
    ///<summary>The id of the recipe to consume eg: 3</summary>
    [JsonPropertyName("recipe_id")]
    public string? RecipeId { get; init; }
}

public partial record GrocyDeleteGenericParameters
{
    ///<summary>The type of entity to be deleted. eg: tasks</summary>
    [JsonPropertyName("entity_type")]
    public object? EntityType { get; init; }

    ///<summary>The ID of the entity to delete. eg: 1</summary>
    [JsonPropertyName("object_id")]
    public string? ObjectId { get; init; }
}

public partial record GrocyExecuteChoreParameters
{
    ///<summary>The id of the chore to execute eg: 3</summary>
    [JsonPropertyName("chore_id")]
    public string? ChoreId { get; init; }

    ///<summary>The id of the user who executed the chore eg: 0</summary>
    [JsonPropertyName("done_by")]
    public string? DoneBy { get; init; }

    ///<summary>If the chore execution should be tracked with the time now eg: False</summary>
    [JsonPropertyName("track_execution_now")]
    public bool? TrackExecutionNow { get; init; }

    ///<summary>Skip next chore schedule eg: False</summary>
    [JsonPropertyName("skipped")]
    public bool? Skipped { get; init; }
}

public partial record GrocyOpenProductParameters
{
    ///<summary>The id of the product to open eg: 3</summary>
    [JsonPropertyName("product_id")]
    public string? ProductId { get; init; }

    ///<summary>The amount to open eg: 1</summary>
    [JsonPropertyName("amount")]
    public long? Amount { get; init; }
...
public partial record GrocyRemoveProductInShoppingListParameters
{
    ///<summary>The id of the shopping list to be added to. eg: 1</summary>
    [JsonPropertyName("list_id")]
    public string? ListId { get; init; }

    ///<summary>The id of the product to remove eg: 3</summary>
    [JsonPropertyName("product_id")]
    public string? ProductId { get; init; }

    ///<summary>The amount to remove eg: 3</summary>
    [JsonPropertyName("amount")]
    public long? Amount { get; init; }
}

public partial record GrocyTrackBatteryParameters
{
    ///<summary>The id of the battery eg: 1</summary>
    [JsonPropertyName("battery_id")]
    public string? BatteryId { get; init; }
}

public partial record GrocyUpdateGenericParameters
{
    ///<summary>The type of entity you like to update. eg: tasks</summary>
    [JsonPropertyName("entity_type")]
    public object? EntityType { get; init; }

    ///<summary>The ID of the entity to update. eg: 1</summary>
    [JsonPropertyName("object_id")]
    public string? ObjectId { get; init; }

    ///<summary>JSON object with what data you want to update (yaml format also works). See Grocy api documentation on Generic entity interactions: https://demo.grocy.info/api</summary>
    [JsonPropertyName("data")]
    public object? Data { get; init; }
}
...
public static class FrigateEntityExtensionMethods
{
    ...
    ///<param name="endTime">End time of exported recording</param>
    ///<param name="name">Optional name for the exported recording. If not provided, the API will generate one. </param>
    public static void ExportRecording(this ICameraEntityCore target, object playbackFactor, DateTime startTime, DateTime endTime, string? name = null)
    {
        target.CallService("export_recording", new FrigateExportRecordingParameters { PlaybackFactor = playbackFactor, StartTime = startTime, EndTime = endTime, Name = name });
    }
    ...
    ///<param name="endTime">End time of exported recording</param>
    ///<param name="name">Optional name for the exported recording. If not provided, the API will generate one. </param>
    public static void ExportRecording(this IEnumerable<ICameraEntityCore> target, object playbackFactor, DateTime startTime, DateTime endTime, string? name = null)
    {
        target.CallService("export_recording", new FrigateExportRecordingParameters { PlaybackFactor = playbackFactor, StartTime = startTime, EndTime = endTime, Name = name });
    }
